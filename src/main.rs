...
#[cfg(not(any(target_env = "msvc")))]
#[unsafe(no_mangle)]
pub static mut malloc_conf: *const c_char = c"percpu_arena:phycpu,tcache:true,tcache_max:262144,thp:never,dirty_decay_ms:1000,muzzy_decay_ms:0".as_ptr();
#[allow(non_upper_case_globals)]
#[cfg(any(target_os = "android", target_os = "macos"))]
#[unsafe(no_mangle)]
pub static mut _rjem_malloc_conf: *const c_char = c"percpu_arena:phycpu,tcache:true,tcache_max:262144,thp:never,dirty_decay_ms:1000,muzzy_decay_ms:0".as_ptr();
